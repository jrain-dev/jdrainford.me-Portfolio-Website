...
export default async function Research() {
  const [projectOne, projectTwo, projectThree, projectFour] = await Promise.all([
    ...
    getGithubRepo('jrain-dev', 'Forklift-Alarm-System'),
    getGithubRepo('jrain-dev', 'portfolio'),
  ])
    ...
    <main className="">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-0 px-4 sm:px-8 md:px-20 lg:px-40 xl:px-70 pt-16 sm:pt-24 md:pt-32 lg:pt-[10rem] pb-8 md:pb-[3rem]">
        ...
        <div className="text-sm sm:text-base md:text-lg">
            <DecodeText
                text="My top few projects, see what I've been working on"
                duration={700}
                scrambleSpeed={55}
                className=""
            />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 px-4 sm:px-8 md:px-20 lg:px-40 xl:px-70 mx-auto">
